...
curl -i -k -L -X POST https://api_key:${ANSIBLE_ADMIN_PASSWD}@localhost:8443/setup/api/configure

# Get the default settings
curl -i -k -L https://api_key:${ANSIBLE_ADMIN_PASSWD}@localhost:8443/setup/api/settings
